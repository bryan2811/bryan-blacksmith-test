		...
		<div class="footer__main">
            <div class="footer__main-company footer-company">
            	<a href="/" class="footer-company__link">
            		<img src="dist/images/general/logo.png" alt="Company" class="footer-company__logo">
            	</a>
                	...
                	<ul class="footer-services__list">
                		<li class="footer-services__list-item">
                			<a href="#" class="footer-services__list-link">
                				<img src="dist/images/general/welding-icon.svg" alt="Welding" class="footer-services__list-icon">
                		...
                		<li class="footer-services__list-item">
                			<a href="#" class="footer-services__list-link">
                				<img src="dist/images/general/welding-icon.svg" alt="Welding" class="footer-services__list-icon">
                				<span class="footer-services__list-label">Coating</span>
                			</a>
                		</li>
                	</ul>
                	...
                	<ul class="footer-brands__list">
                		<li class="footer-brands__list-item">
                			<a href="#" class="footer-brands__list-link">
                				<img src="dist/images/general/logo.png" alt="" class="footer-brands__list-logo">
                			</a>
                		</li>
                		<li class="footer-brands__list-item">
                			<a href="#" class="footer-brands__list-link">
